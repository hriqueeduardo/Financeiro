                                    ...
                                    <tr id="dados">
                                        ...
                                        <td>
                                            ...
                                            <a href="#modalAlterar-{{ $conta->id }}" class="btn btn-outline-primary"
                                                ...
                                                data-bs-target="#modalAlterar-{{ $conta->id }}"
                                                style="margin: 0 5px 0 5px;">Alterar</a>
                                            @include('../components.modal_alterar')

                                            <a href="#modalExcluir-{{ $conta->id }}" class="btn btn-outline-danger"
                                                data-bs-toggle="modal"
