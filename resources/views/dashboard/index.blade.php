<x-layout title="Dashboard">
    ...
    <x-modal_excluir></x-modal_excluir>
            ...
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <div class="card border-warning   mb-3">
                        <div class="bg-warning   text-light card-header border-warning  "><strong>DISPONÍVEL</strong>
                        </div>
                    ...
                    <div class="card border-success   mb-3">
                        <div class="bg-success   text-light card-header border-success  "><strong>TOTAL PAGO</strong>
                        </div>
